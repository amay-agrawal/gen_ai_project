import { INTENT_EXTRACTION_PROMPT, buildIntentExtractionMessage, } from '../llm/prompts/intentExtraction.js';
...
export class VoiceService {
    ...
    async parseIntent(transcript, orgId) {
        const scriptPath = path.join(__dirname, '..', 'python-agents', 'parse_intent.py');
